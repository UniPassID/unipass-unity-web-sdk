...
namespace UnipassWallet
{
    ...
    /// </summary>
    public class UnipassHardwareKeyboardListener : MonoBehaviour
    {

        [Obsolete("The UnipassHardwareKeyboardListener.InputReceived event is now deprecated. Please use the UnipassHardwareKeyboardListener.KeyDownReceived event instead.")]
        ...
        public static UnipassHardwareKeyboardListener Instantiate()
        {

            return (UnipassHardwareKeyboardListener)new GameObject("UnipassHardwareKeyboardListener").AddComponent<UnipassHardwareKeyboardListener>();
        }
